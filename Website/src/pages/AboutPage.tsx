          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
              ...
              <div className="space-y-8">
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                  Today, we support thousands of merchants across the globe, processing millions in GMV annually through our streamlined interface.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-24 bg-slate-900 overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: "Customer First", desc: "We build for you, not for us. Your success is our primary metric." },
                { title: "Simplicity", desc: "Complexity is the enemy of execution. We make the complex feel simple." },
                { title: "Transparency", desc: "No hidden fees, no black boxes. We believe in clear communication." }
              ].map((value, idx) => (
                <div 
                  key={idx} 
